...
Within the "Projects" folder, you should create a folder for each one of your project using the following syntax: **YYYY_<ProjectName>_<YourInitials>** (e.g., 2024_BSB_RangeWide_RG).  
...
- Metadata (please upload any metadata preferably downloaded )
