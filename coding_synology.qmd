...
Within the "Projects" folder, you should create a folder for each one of your project using the following syntax: **YYYY_ProjectName_YourInitials** (e.g., 2024_BSB_RangeWide_RG).  
