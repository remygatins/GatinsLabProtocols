# 3x Bead Cleanup for Genomic DNA
## KAPA Pure Beads
KS8001
...
## Preparation:
  1. Take beads out of refrigerator and allow them to come to room temperature before beginning. Vortex well.
...
## Protocol:
  ...
  5. On magnet, add 100uL of 80% ethanol to each sample. If 100uL does not sufficiently cover the beads, increase this volume.
  ...
  10. Resuspend beads in elution buffer (heated to 37C) and vortex and spin. Choose your elution buffer volume by adding 5uL to your desired final volume. For example, if you want 50uL of clean genomic DNA, elute in 55uL.
