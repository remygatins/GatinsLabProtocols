...
## Prep:
### Bleaching (eg. filter holders, other filtering materials, bottles, and stoppers)
...
2. prep filters:
   - using clean forcepts and wearing clean gloves, place 1 polyester (PETE) Drain disc (mesh spacer) onto metal mesh on black filter housing piece
   - then place 1 cellulose nitrate membrane filter on top of drain disc
   - take beige housing piece and click onto black piece
   - place into clean ziplock bag
   - add 1 pair of sterile plastic forcepts and 1 clear hard plastic tubing into same bag
   - seal and store on shelf
   - change gloves and clean forcepts frequently
...
1. Prep tanks for experiment
   - clean tanks
   - fill tanks
   - standardize water height and water flow rate
   - add organisms to tanks
      - decide # of organisms per tank
      - figure out how to standardize (size, gender...)
      - have empty tank for control (could also have other tanks with different organism)
   - decide how many hours after organism addition or removal you want to filter water
   - add temp loggers
...
11. Pour storage container water out (either back into same tank you took it from, or onto glass/rocks)
12. Place storage container back citizen scientist sampler (with lid screwed on)
14. Change gloves
...
- bleach nalgene bottles, stoppers, and filter supplies
- prep filter bags
