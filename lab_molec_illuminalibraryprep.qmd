...
- [ ] 7.a.0 First, add 13.3 µL of molecular H2O to increase the final volume after the PCR from 16.7 µL to 30 µL. 

- [ ] 7.a.1 In the same plate/tube(s), perform a **0.56X** beadbased cleanup by combining the following:
...
- [ ] 7.a.2 Mix thoroughly by vortexing and/or pipetting up and down multiple times.

- [ ] 7.a.3 Incubate the plate/tube(s) at room temperature for 15 min or less to bind DNA to the beads.

- [ ] 7.a.4 Place the plate/tube(s) on a magnet to capture the beads. Incubate until the liquid is clear.

- [ ] 7.a.5 Carefully remove and **KEEP THE SUPERNATANT and discard the beads**
...
| KAPA cleanup beads (**0.72X**) | 36 µL | 33.7 µL | use 21.6 µL calculated from prior volume of 30 µL|
|--------------------|------|------|------|
